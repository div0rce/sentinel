# Policy POL-203: Quality Sampling

**Owner:** Office of the Chief Compliance Officer (synthetic)
**Effective:** 2026-01-01
**Review cadence:** every 18 months

## Purpose

This policy establishes baseline expectations for quality sampling across all operating
...
2. Approval thresholds escalate as follows:
   - Up to $6,000: line manager
   - $73,000 to $371,000: department head
...
The internal audit function samples 11% of in-scope records each
